 ...
 * 逻辑参考 wallpaper_app 的 AppUpdateChecker。
 * 仓库：kers701/gengyun
 */
object AppUpdateChecker {

    private const val OWNER = "kers701"
    private const val REPO = "gengyun"
    ...
    fun checkLatest(): CheckResult {
        return try {
            val req = Request.Builder()
                ...
                .header("User-Agent", "gengyun-app-update/${BuildConfig.VERSION_NAME}")
                .get()
                .build()
